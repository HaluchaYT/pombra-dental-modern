...
export default function Nav() {
  ...
  return (
    <>
        ...
        <div className="container-x flex items-center justify-between py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              aria-expanded={open}
              onClick={() => setOpen((v) => !v)}
              className="lg:hidden grid place-items-center h-11 w-11 rounded-full border border-teal-200 text-teal-600 hover:bg-teal-50 active:bg-teal-100 transition"
            >
      ...
      {/* Mobile drawer — MUST be outside <header> because the header's
      ...
      >
        <div
          ...
          className={`absolute inset-0 bg-ink-900/50 backdrop-blur-sm transition-opacity duration-300 ${
        ...
        <aside
          ...
          className={`absolute right-0 top-0 h-full w-[86%] max-w-sm bg-cream-50 shadow-2xl flex flex-col transition-transform duration-300 ease-out ${
        ...
        >
          <div className="flex items-center justify-between border-b border-teal-100 p-5 flex-shrink-0">
            ...
            <button
              ...
              onClick={() => setOpen(false)}
              className="grid place-items-center h-10 w-10 rounded-full border border-teal-200 text-teal-600 hover:bg-teal-50"
            >
